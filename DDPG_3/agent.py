...
class BaseAgent(object):
    def __init__(self, sess, replay_buffer, noise=None, exploration_episodes=7000, max_episodes=10000, max_steps_episode=400, warmup_steps=10000,\
            mini_batch=64, eval_episodes=20, eval_periods=100, env_render=False, summary_dir=None):
        """
