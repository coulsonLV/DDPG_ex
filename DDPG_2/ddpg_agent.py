        ...
        for cur_episode in tqdm(range(self.max_episodes)):
            ...
            for cur_step in range(self.max_steps_episode):
                ...
                if self.replay_buffer.size() < self.warmup_steps:
                    ...
                    action = np.array([a1, a2, a3, A_1[0], A_1[1], A_1[2],A_3[0],A_3[1],A_3[2]])
                else: 
                    if cur_episode < self.exploration_episodes and self.noise is not None:
                        ...
                        action = np.array([action[0], action[1], action[2], A_1[0], A_1[1], A_1[2],A_3[0],A_3[1],A_3[2]])
                    else: 
                ...
                action = np.array([action[0],action[1],action[2],action[3],action[4],action[5],action[6],action[7],action[8]])
                a = action.reshape((9,))
                # print('a:',a)
